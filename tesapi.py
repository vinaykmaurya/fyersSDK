...
def api_call(token,client_id):
	...
	data = {"symbol":"NSE:SBIN-EQ","resolution":"1","date_format":"0","range_from":"1676866453","range_to":"1676880853","cont_flag":"1"}
...
def getauthToken(client_id,redirect_uri,response_type,scope,state,nonce):
	...
	"""
	appSession = SessionModel(client_id = client_id, redirect_uri = redirect_uri,response_type=response_type,scope=scope,state=state,nonce=nonce)
...
def generate_access_token(auth_code,client_id,redirect_uri,secret_key,grant_type):
	...
	# import ipdb;
	# ipdb.set_trace()
	appSession = SessionModel(client_id = client_id,redirect_uri =redirect_uri,secret_key = secret_key,grant_type=grant_type)
...
def main():
	...
	auth_code = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..q-vSTsKEYK1OpcoXiA9agqGwjKQICaQR_bYnKuQTwz0"

	# print(generate_access_token(auth_code, client_id, redirect_uri,secret_key,grant_type))

	access_token ="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..kGkxsXQ3s064gGBJzTgzZm420XA-G5mh2-34N1GmKlg"
